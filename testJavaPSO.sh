...
/usr/bin/env /Library/Java/JavaVirtualMachines/temurin-17.jdk/Contents/Home/bin/java -XX:+ShowCodeDetailsInExceptionMessages -cp /Users/davidgerard/Documents/Coding/UMASS/Research/adPSOScheduler/psoscheduler/target/classes syslab.cloudcomputing.schedule.Scheduler $1 $2
